...
INSERT INTO `keluar_baku` (`id_keluar_baku`, `id_barang_baku`, `jumlah_keluar`, `tanggal_keluar`, `status_keluar`, `input_status_keluar`, `tgl_input_keluar`) VALUES
(1, 1, 1, '2023-09-01', 1, 'Muh Abd Cholil', '2023-09-30 22:19:11');
...
CREATE TABLE `masuk_baku` (
  ...
  `status_masuk` int(1) NOT NULL DEFAULT 1,
...
CREATE TABLE `rusak_baku` (
  ...
  `tanggal_rusak_baku` datetime NOT NULL,
...
--
-- Table structure for table `stok_awal_baku`
--

CREATE TABLE `stok_awal_baku` (
  `id_stok_awal_baku` int(11) NOT NULL,
  `id_barang_baku` int(11) NOT NULL,
...
--
-- Dumping data for table `stok_awal_baku`
--

INSERT INTO `stok_awal_baku` (`id_stok_awal_baku`, `id_barang_baku`, `jumlah_stok_awal_baku`, `tanggal_stok_awal_baku`, `status_stok_awal_baku`, `input_status_stok_awal_baku`, `tgl_input_stok_awal_baku`) VALUES
(1, 1, 71, '2023-01-16', 1, 'Dwi Bekti Hariyanto', '2023-09-30 21:30:57'),
(2, 3, 64000, '2023-01-16', 1, 'Dwi Bekti Hariyanto', '2023-09-30 21:44:18'),
(3, 2, 10000, '2023-01-16', 1, 'Dwi Bekti Hariyanto', '2023-09-30 21:45:01');
...
--
-- Indexes for table `stok_awal_baku`
--
ALTER TABLE `stok_awal_baku`
  ADD PRIMARY KEY (`id_stok_awal_baku`),
  ADD KEY `id_barang_baku` (`id_barang_baku`);
...
--
ALTER TABLE `keluar_baku`
  MODIFY `id_keluar_baku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `masuk_baku`
--
ALTER TABLE `masuk_baku`
  MODIFY `id_masuk_baku` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `stok_awal_baku`
--
ALTER TABLE `stok_awal_baku`
  MODIFY `id_stok_awal_baku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Constraints for table `stok_awal_baku`
--
ALTER TABLE `stok_awal_baku`
  ADD CONSTRAINT `stok_awal_baku_ibfk_1` FOREIGN KEY (`id_barang_baku`) REFERENCES `barang_baku` (`id_barang_baku`) ON UPDATE CASCADE;
COMMIT;

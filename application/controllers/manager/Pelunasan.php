...
class Pelunasan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'Daftar Pelunasan AMDK';
        ...
        if ($this->session->userdata('level') == 'Admin') {
            ...
            $this->load->view('manager/view_pelunasan', $data);
    ...
    public function pertanggal()
    {
        ...
        $data['title'] = 'Daftar Pelunasan Pertanggal AMDK';
        ...
        if ($this->session->userdata('level') == 'Admin') {
            ...
            $this->load->view('templates/navbar');
            $this->load->view('templates/sidebar');
            $this->load->view('manager/view_pelunasan_pertanggal', $data);
            $this->load->view('templates/footer');
        } else {
            $this->load->view('templates/pengguna/header', $data);
            $this->load->view('templates/pengguna/navbar_uang');
    ...
    public function nama_pelanggan()
    {
        ...
        $data['title'] = 'Daftar Pelunasan Berdasarkan Nama Pelanggan';
        ...
        if ($this->session->userdata('level') == 'Admin') {
            ...
            $this->load->view('templates/navbar');
            $this->load->view('templates/sidebar');
            $this->load->view('manager/view_pelunasan_perpelanggan', $data);
            $this->load->view('templates/footer');
        } else {
            $this->load->view('templates/pengguna/header', $data);
            $this->load->view('templates/pengguna/navbar_uang');
    ...
    public function pilih_lunas($id_pemesanan)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->session->userdata('level') == 'Admin') {
                ...
                $this->load->view('templates/navbar');
                $this->load->view('templates/sidebar');
                $this->load->view('manager/view_pilih_lunas_pelunasan', $data);
                $this->load->view('templates/footer');
            } else {
                $this->load->view('templates/pengguna/header', $data);
                $this->load->view('templates/pengguna/navbar_uang');
            ...
            if ($cek_lunas->status_bayar == 0) {
                ...
                // $alamat = 'manager/pelunasan?tanggal=' . $tanggal;
                // redirect($alamat);
                redirect('manager/pelunasan');
            } else {
                $this->session->set_flashdata(
                    'info',

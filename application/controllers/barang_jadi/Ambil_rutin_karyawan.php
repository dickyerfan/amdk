...
class Ambil_rutin_karyawan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('level') == 'Admin') {
            ...
            $this->load->view('barang_jadi/view_ambil_rutin_karyawan', $data);
    ...
    public function exportpdf_belum()
    {
        ...
        $this->pdf->generate('barang_jadi/laporan_rutin_kyw_belum_pdf', $data);
    }
    ...
    public function edit($id_ambil_rutin)
    {
        ...
        $this->load->view('templates/pengguna/navbar_jadi');
        $this->load->view('templates/pengguna/sidebar_jadi');
        $this->load->view('barang_jadi/view_edit_ambil_rutin_karyawan', $data);
        $this->load->view('templates/pengguna/footer_jadi');
    }
    ...
    public function exportpdf_sudah()
    {
        ...
        $this->pdf->generate('barang_jadi/laporan_rutin_kyw_sudah_pdf', $data);
    }
}

...
class Model_penjualan extends CI_Model
{
    ...
    {
        $this->db->select('pemesanan.status_bayar, pemesanan.id_pelanggan, pemesanan.jumlah_pesan, pemesanan.total_harga, pemesanan.id_jenis_barang,jenis_barang.nama_barang_jadi, pelanggan.nama_pelanggan');
        $this->db->from('pemesanan');

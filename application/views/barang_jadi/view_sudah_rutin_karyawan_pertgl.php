            ...
            <div class="card">
                <div class="card-header shadow">
                    <nav class="navbar navbar-light bg-light">
                        <form id="form_bulan" action="<?= base_url('barang_jadi/ambil_rutin_karyawan/sudah_ambil'); ?>" method="get">
                            <div style="display: flex; align-items: center;">
                                <input type="submit" value="Data Perbulan"  class="neumorphic-button">
                                <input type="month" id="bulan" name="tanggal" class="form-control" style="margin-left: 5px;">
                            </div>
                        </form>
                        <form id="form_tanggal" action="<?= base_url('barang_jadi/ambil_rutin_karyawan/sudah_ambil_pertgl'); ?>" method="get">
                            <div style="display: flex; align-items: center;" class="ms-2">
                                <input type="submit" value="Data Pertanggal" class="neumorphic-button">
                        ...
                        <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('barang_jadi/ambil_rutin_karyawan') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-reply"></i> Daftar Belum Ambil</button></a>
                        </div>
                    </nav>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= date('Y-M', strtotime($row->tgl_lap)); ?></td>
                                        <td class="text-center"><?= date('Y-m-d', strtotime($row->tgl_ambil)); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                            <tfoot>

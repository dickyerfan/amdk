                ...
                <div class="card-body">
                    ...
                    <div class="card p-2">
                        <div class="row justify-content-center">
                            <?php foreach ($detail_barang_masuk as $row) : ?>
                                <div class="col-lg-6">
                                    <div class="card mb-2">
                                        <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <table class="table table-borderless">
                                                <tr>
                                                    <td class="text-center">Bukti Surat Jalan</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <img src="<?= base_url('uploads/baku/masuk/' . $row->bukti_masuk_sj); ?>" alt="" style="width: 100%;">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-borderless">
                                                ...
                                                <tr>
                                                    ...
                                                    <td> : </td>
                                                    <td><?= $row->tgl_input_masuk; ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Tanggal Gudang</td>
                                                    <td> : </td>
                                                    <td><?= $row->tgl_update_masuk; ?></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <div class="card-body">
                                            <table class="table table-borderless">
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?= base_url('uploads/baku/masuk/' . $row->bukti_masuk_gd); ?>" alt="" style="width: 100%;">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>

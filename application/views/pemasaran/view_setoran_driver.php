            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-light bg-light">
                        <form id="form_tanggal" action="<?= base_url('pemasaran/setoran/nama_driver'); ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <form id="form_driver" action="<?= base_url('pemasaran/setoran/nama_driver'); ?>" method="get">
                                <div style="display: flex; align-items: center;">
                        ...
                        <div class="navbar-nav ms-2">
                            <a href="<?= base_url('pemasaran/setoran') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Total Setoran</button></a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('pemasaran/setoran/exportpdf?driver=') . urlencode($this->input->get('driver')) ?>" target="_blank" style="font-size: 0.8rem; color:black;">

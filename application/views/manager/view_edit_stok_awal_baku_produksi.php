    ...
    <main>
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="user" action="<?= base_url('manager/stok_awal_baku_produksi/update') ?>" method="POST">
                        <div class="row justify-content-center">
                            <div class="col-md-6 mb-3">
                                <div class="form-group mb-3">
                                    <div class="form-group">
                                        <label for="id_stok_awal_baku_produksi" class="mb-2">Nama Barang Baku</label>
                                        <input type="hidden" class="form-control" id="id_stok_awal_baku_produksi" name="id_stok_awal_baku_produksi" value="<?= $edit_stok->id_stok_awal_baku_produksi; ?>">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_stok_awal_baku" name="tanggal_stok_awal_baku" placeholder="Masukan NIK Karyawan" value="<?= $edit_stok->tanggal_stok_awal_baku; ?>" disabled>

                ...
                <div class="card-header shadow">
                    <nav class="navbar navbar-light bg-light">
                        ...
                        <!-- <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('manager/pelunasan/export_pelanggan') ?>" target="_blank"><button class="float-end neumorphic-button"> Cetak Piutang</button></a>
                        </div> -->
                        <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('manager/pelunasan') ?>"><button class="float-end neumorphic-button"> Semua Piutang</button></a>
                        </div>
                        <!-- <div class="navbar-nav ms-2">
                            <form id="form_produk" action="<?= base_url('manager/pelunasan/nama_produk'); ?>" method="post">
                                <div style="display: flex; align-items: center;">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                if ($row->status_bayar == 1 && $row->status_nota == 1) {
                                                    ...
                                                    $url = base_url('manager/pelunasan/pilih_lunas/') . $row->id_pemesanan;
                                                }
                                                ?>

                ...
                <div class="card-header shadow">
                    <nav class="navbar navbar-light bg-light">
                        ...
                        <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('manager/stok_awal_baku_produksi/upload') ?>"><button class="float-end neumorphic-button"><i class="fas fa-plus"></i> Tambah Stok Awal Produksi</button></a>
                        </div>
                    </nav>
                </div>
                <div class="p-2">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($stok_barang as $row) : ?>
                                            <tr class="text-center">
                                                ...
                                                <td><?= $row->tgl_input_stok_awal_baku; ?></td>
                                                <td>
                                                    <a href="<?= $this->session->userdata('level') == 'Admin' ? base_url('manager/stok_awal_baku_produksi/edit/') : "javascript:void(0)" ?><?= $row->id_stok_awal_baku_produksi; ?>"><i class="fas fa-edit text-success"></i></a>

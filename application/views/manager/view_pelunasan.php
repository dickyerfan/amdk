            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-light bg-light">
                        <form id="form_bulan" action="<?= base_url('manager/pelunasan'); ?>" method="get">
                        ...
                        <div class="navbar-nav me-auto ms-2">
                            <form id="form_tanggal" action="<?= base_url('manager/pelunasan/pertanggal'); ?>" method="get">
                                <div style="display: flex; align-items: center;">
                        ...
                        <!-- <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('manager/pelunasan/export_bulan_all') ?>" target="_blank"><button class="float-end neumorphic-button"> Cetak Piutang</button></a>
                        </div> -->
                        <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('manager/pelunasan') ?>"><button class="float-end neumorphic-button"> Semua Piutang</button></a>
                        </div>
                        ...
                        <div class="navbar-nav ms-2">
                            <form id="form_pelanggan" action="<?= base_url('manager/pelunasan/nama_pelanggan'); ?>" method="post">
                                <div style="display: flex; align-items: center;">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="text-center">
                                                ...
                                                <td><?= $row->status_setoran_driver == 1 ? '<span class="btn btn-primary btn-sm" style="font-size: 0.7rem;">Ada</span>' : '<span class="btn btn-danger btn-sm" style="font-size: 0.7rem;">Belum</span>'; ?></td>
                                                <td>
                                                    <?php
                                                    ...
                                                    } else if ($row->status_setoran_driver == 0) {
                                                    ...
                                                    } else if ($this->session->userdata('nama_user') == 'langgan' && $this->session->userdata('nama_user') == 'spi' && $this->session->userdata('nama_user') == 'admin' && $this->session->userdata('nama_pengguna') != 'Manager') {
                                                        $onclick = "Swal.fire('Peringatan', 'Admin tidak bisa proses.', 'warning');";
                                                    } else {
                                                        $onclick = "window.location.href='" . base_url('manager/pelunasan/pilih_lunas/') . $row->id_pemesanan . "';";
                                                    }
                                                    ?>

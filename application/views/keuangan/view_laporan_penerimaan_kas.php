            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-light bg-light">
                        <form id="form_bulan" action="<?= base_url('keuangan/penerimaan_kas'); ?>" method="get">
                            <div style="display: flex; align-items: center;">
                                <input type="submit" value="Tampilkan Data" class="neumorphic-button">
                                <input type="date" id="bulan" name="tanggal" class="form-control" style="margin-left: 5px;">
                            </div>
                        </form>
                        <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('keuangan/penerimaan_kas/exportpdf') ?>" target="_blank" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button></a>
                        </div>
                    </nav>
                </div>
                <div class="p-2">
                                ...
                                <table class="table table-sm table-bordered" style="font-size: 0.7rem;">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="text-center" rowspan="2" style=" vertical-align: middle;">Action</td>
                                        </tr>
                                        <tr>
                                            <?php foreach ($nama_barang as $jenis) : ?>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($dateRange as $tanggal) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="<?= base_url('keuangan/penerimaan_kas/detail_kas/') . date('Y-m-d', strtotime($tanggal)) ?>" style="text-decoration: none; font-size:0.7rem;" class="btn btn-primary btn-sm">Detail</a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                    <tfoot>

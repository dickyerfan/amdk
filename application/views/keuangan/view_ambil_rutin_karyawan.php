            ...
            <div class="card">
                <div class="card-header shadow">
                    <nav class="navbar navbar-light bg-light">
                        <form action="<?= base_url('keuangan/ambil_rutin_karyawan'); ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <a href="<?= base_url('keuangan/ambil_rutin_karyawan/exportpdf_belum') ?>" target="_blank" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button></a>
                        </div>
                        <div class="navbar-nav ms-2">
                            <a href="<?= base_url('keuangan/ambil_rutin_karyawan/sudah_ambil') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-check-to-slot"></i> Daftar Sudah Ambil</button></a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <form action="<?= base_url('keuangan/ambil_rutin_karyawan/download'); ?>" method="post">

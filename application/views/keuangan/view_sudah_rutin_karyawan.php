            ...
            <div class="card">
                <div class="card-header shadow">
                    <nav class="navbar navbar-light bg-light">
                        <form action="<?= base_url('keuangan/ambil_rutin_karyawan/sudah_ambil'); ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <a href="<?= base_url('keuangan/ambil_rutin_karyawan/exportpdf_sudah') ?>" target="_blank" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button></a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('keuangan/ambil_rutin_karyawan') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-reply"></i> Kembali</button></a>
                        </div>
                    </nav>

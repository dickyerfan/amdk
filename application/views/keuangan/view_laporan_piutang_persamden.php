                ...
                <div class="card-header shadow">
                    <nav class="navbar navbar-light bg-light">
                        ...
                        <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('keuangan/laporan_piutang/exportpdf_samden') ?>" target="_blank" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button></a>
                        </div>
                    </nav>
                </div>
                <div class="p-2">
                            ...
                            <div class="col-lg-12">
                                <div>
                                    ...
                                    <?php
                                        ...
                                        // Logika untuk menampilkan bulan dan tahun jika tanggal tidak kosong
                                        list($tahun, $bulan, $hari) = explode('-', $samden);
                                        list($tahunLap, $bulanLap, $hariLap) = explode('-', $samden);
                                    ...
                                    ?>
                                        <p class="mu-0 text-center">sampai/dengan : <?=$hariLap.' '. $bulanLap[$bulan] . ' ' . $tahunLap ?></p>
                                    <?php
                                    }
                                    ?>
                                </div>

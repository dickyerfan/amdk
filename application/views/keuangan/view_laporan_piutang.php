                ...
                <div class="card-header shadow">
                    <nav class="navbar navbar-light bg-light">
                        ...
                        <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('keuangan/laporan_piutang/exportpdf') ?>" target="_blank" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button></a>
                        </div>
                    </nav>
                </div>
                <div class="p-2">

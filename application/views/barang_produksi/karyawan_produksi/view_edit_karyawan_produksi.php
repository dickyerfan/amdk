        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header card-outline card-primary shadow">
                    ...
                    <a href="<?= base_url('barang_produksi/karyawan_produksi'); ?>"><button class=" neumorphic-button float-end"><i class="fas fa-reply"></i> Kembali</button></a>
                </div>
                <div class="card-body">
                    <form class="user" action="<?= base_url('barang_produksi/karyawan_produksi/update') ?>" method="POST">
                        <div class="row">

        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header shadow">
                    ...
                    <a href="<?= base_url('barang_produksi/karyawan_produksi/absensi_karyawan'); ?>"><button class=" neumorphic-button float-end"><i class="fas fa-reply"></i> Kembali</button></a>
                </div>
                <!-- <div class="p-2">
                    ...
                    <div class="row ms-4">
                        <div class="col-auto">
                            <form method="post" action="">
                                <!-- <form method="post" action="<?php echo site_url('controller_name/insert_absen'); ?>"> -->

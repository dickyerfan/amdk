                ...
                <div class="card-body">
                    <form class="user" action="" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="nama_user" name="nama_user" placeholder="Masukan Nama User" value="<?= set_value('nama_user'); ?>">
                                    <small class="form-text text-danger pl-3"><?= form_error('nama_user'); ?></small>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">

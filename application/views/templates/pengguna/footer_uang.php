...
<script>
    function checkStatusPesan() {
        $.ajax({
            type: 'POST',
            url: '<?= base_url('keuangan/penjualan/cek_status_pesanan') ?>',
            dataType: 'json',
    ...
    // Memanggil fungsi checkStatusPesan setiap 5 detik

    setInterval(function() {
        checkStatusPesan(); // Pemanggilan fungsi tampil_data_barang
